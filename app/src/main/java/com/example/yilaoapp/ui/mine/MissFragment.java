 ...
 * Use the {@link MissFragment#newInstance} factory method to
...
public class MissFragment extends Fragment {
    ...
    public static MissFragment newInstance(String param1, String param2) {
        MissFragment fragment = new MissFragment();
